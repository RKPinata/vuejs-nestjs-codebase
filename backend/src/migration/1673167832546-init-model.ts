...
export class initModel1673167832546 implements MigrationInterface {
    name = 'initModel1673167832546'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_info" ("id" SERIAL NOT NULL, "pet_name" character varying, "address" character varying, CONSTRAINT "PK_273a06d6cdc2085ee1ce7638b24" PRIMARY KEY ("id"))`);
